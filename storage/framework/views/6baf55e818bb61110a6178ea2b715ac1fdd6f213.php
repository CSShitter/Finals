            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1">
                        <div class="p-4">
                            <div class="flex items-center overflow-hidden">
                                <h2>Your Tracking Number: </h2><h2 id ="bruh"></h2>
                            </div>
                            <br>
                        ...
                        var tracking;
                        var output = document.getElementById('bruh');
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                      <div class="ml-4 text-center text-xsm text-gray-500 sm:text-right sm:ml-0">
...
<?php /**PATH E:\BruhShitter\Finals2\resources\views/TN.blade.php ENDPATH**/ ?>