        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            ...
            <div class="max-w-4xl sm:px-6 lg:px-8">
                <div class="flex justify-left pt-8 sm:justify-start sm:pt-0">
                  <img src="<?php echo e(url('/images/logo.png')); ?>" alt="Logo" style="width:100%; height:200px;">
                </div>
              </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1">
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="ml-1 text-lg leading-7 font-semibold">Place Order</div>
                            </div>
                            <br>
                            ...
                            <form class="" action="index.html" method="post">
                              <div class="row form-group">
                                <div class="col-md-12">
                                  ...
                                  <input type="text" name="CusName" value=""class="form-control">
                                </div>
                              </div>

                              <div class="row form-group">
                                <div class="col-md-12">
                                  <label for="text">Pick Up Address</label>
                                  <input type="text" name="CusPUAdd" value="" class="form-control">
                                </div>
                              </div>

                              <div class="row form-group">
                                <div class="col-md-12">
                                  <label for="text">Drop Off Address</label>
                                  <input type="text" name="CusDOAdd" value="" class="form-control">
                                </div>
                              </div>
                              <div class="row form-group">
                                <div class="col-md-12">
                                  <label for="text">Mobile Number</label>
                                  <input type="text" name="MobNum" value="" class="form-control">
                                </div>
                              </div>
                              <div class="row form-group">
...
<?php /**PATH E:\BruhShitter\Finals2\resources\views/orderplace.blade.php ENDPATH**/ ?>